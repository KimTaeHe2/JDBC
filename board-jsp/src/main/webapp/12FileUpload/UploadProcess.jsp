...
try{
	...
	// 저장할 디렉토리 http://192.168.111.101:80/board-jsp/Upload
	...
	// 4. FileUploadMain에서 넘어온 값 처리
	
	String name = mr.getParameter("name");
	String title = mr.getParameter("title");
	String[] cateArray=mr.getParameterValues("cate");
	StringBuffer cateBuf = new StringBuffer(); // String add 가능
	if(cateArray == null){
		cateBuf.append("선택없음");
	}
	else{
...
<title>UploadProcess.jsp : cos.jar 를 활용하여 파일처리 하고 DAO로 연결한다.</title>
</head>
<body>
