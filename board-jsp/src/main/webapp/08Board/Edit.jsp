...
<body>
	...
	<form name="writeFrm" method="post" action="EditProcess.jsp"
		...
		<table border="1" width="90%">
			<tr>
				<td>제목</td>
				<td><input type="text" name="title" style="width: 90%;" value="<%=boardDTO.getTitle() %>"/> </td>
			</tr>
			<tr>
				<td>내용</td>
				<td><textarea name="content" style="width: 90%; height: 100px;"><%= boardDTO.getContent() %></textarea>
				</td>
			</tr>
			<tr>
